...
from crowd_sec_python_sdk.exceptions_base import ApiValueError
from crowd_sec_python_sdk.exceptions import ClientConfigurationError
from crowd_sec_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = crowd_sec_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://127.0.0.1/v1" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if api_key_authorizer:
            self.api_key['APIKeyAuthorizer'] = api_key_authorizer
        if jwt_authorizer:
            self.api_key['JWTAuthorizer'] = jwt_authorizer
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("crowd_sec_python_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'APIKeyAuthorizer' in self.api_key:
        ...
        if 'JWTAuthorizer' in self.api_key:
            auth['JWTAuthorizer'] = {
                'type': 'api_key',
                'in': 'header',
